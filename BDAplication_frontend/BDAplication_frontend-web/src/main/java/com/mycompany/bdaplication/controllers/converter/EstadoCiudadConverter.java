 ...
 * @author Roberth
 */
@FacesConverter(value = "estadoCiudadConverter", forClass = EstadoDTO.class)
public class EstadoCiudadConverter implements Converter {
      @Override
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        if (value.trim().equals("")) {
            ...
            try {
                ...
                for (EstadoDTO estado : ciudadViewBean.getListaEstados()) {
