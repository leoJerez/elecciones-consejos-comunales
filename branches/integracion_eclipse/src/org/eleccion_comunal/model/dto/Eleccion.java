...
public class Eleccion extends EntidadGenerica implements Serializable {
	...
	@Id
	@SequenceGenerator(name="ELECCION_IDELECCION_GENERATOR", sequenceName = "eleccion_id__eleccion_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="ELECCION_IDELECCION_GENERATOR")
