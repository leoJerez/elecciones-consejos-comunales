...
public class Parroquia extends EntidadGenerica implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "ParroquiaSequence", sequenceName = "parroquia_id_parroquia_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ParroquiaSequence")
