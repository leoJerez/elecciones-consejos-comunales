...
public class MiembrosConsejo extends EntidadGenerica implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "MiembrosConsejoSequence", sequenceName = "miembros_consejo_id_miembro_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "MiembrosConsejoSequence")
