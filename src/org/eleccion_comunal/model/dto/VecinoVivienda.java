...
public class VecinoVivienda extends EntidadGenerica implements Serializable {
	...
	@Id
	@SequenceGenerator(name="VECINO_VIVIENDA_IDVECINOVIVIENDA_GENERATOR", sequenceName = "vecino_vivienda_id_vecino_vivienda_seq", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="VECINO_VIVIENDA_IDVECINOVIVIENDA_GENERATOR")
